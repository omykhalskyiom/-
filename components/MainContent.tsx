...
const mockProducts: Product[] = [
  // Шаурма
  { id: 1, name: 'Класична шаурма з куркою', category: 'Шаурма', price: 155.00, imageUrl: 'https://i.imgur.com/4zJqXj1.jpeg', description: 'Лаваш, куряче філе, свіжі овочі, часниковий соус, кетчуп, сир. Обсмажується до золотистої скоринки.', rating: 4.8, ingredients: ['Лаваш', 'Куряче філе', 'Капуста', 'Помідори', 'Огірки', 'Часниковий соус'], calories: 450 },
